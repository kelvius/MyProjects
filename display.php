...
if (filteredData()) {
    ...
    // SQL is written as a String.
    $query_comments = "SELECT * FROM comments WHERE post_id = $id ORDER BY comment_id DESC";
                                        ...
                                        <form action="comment_post.php" method="post">
                                            ...
                                            <?php if ($row['visibility'] === 1): ?>
                                                <input type="submit" name="visibility" value="Hide"
                                                    onclick="return confirm('Are you sure you wish to Hide this post?')">
                                            <?php else: ?>
                                                <input type="submit" name="visibility" value="Unhide"
                                                    onclick="return confirm('Are you sure you wish to Unhide this post?')">
                                            <?php endif ?>
